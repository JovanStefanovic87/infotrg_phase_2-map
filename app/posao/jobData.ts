...
export const contentData: BasicInformation[] = [
  ...
  }, */
	{
		...
		isLink: false,
		opisPosla: [
			'Obilazak prodajnih objekata u Subotici',
			'Neposredna komunikacija sa prodavcima',
			'Distribucija promotivnog materijala',
			'Naplata prihoda od objavljivanja reklama',
		],
		usloviRada: [
			'Angažman prema potrebi',
			'Rad na terenu',
		...
		potrebneKvalifikacije: [
			'Neformalno obrazovanje u oblasti ekonomije i marketinga',
			'Komunikacione veštine',
			'Poželjno znanje mađarskog jezika',
	...
	},
	{
		...
		isLink: false,
		opisPosla: [
			'Distribucija promotivnih flajera posetiocima tržnog centra',
			'Neposredna komunikacija sa posetiocima tržnog centra',
			'Odvođenje kupaca na mesto prodaje u tržnom centru',
		],
		usloviRada: [
			'Sezonski angažman (novembar, decembar, mart)',
			'Radno vreme vikendom (09:00-13:00)',
			'Honorar: 6 evra/sat',
		],
		potrebneKvalifikacije: [
			'Komunikacione veštine',
