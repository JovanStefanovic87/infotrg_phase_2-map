...
var ChooseImageButton = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: 'mb-4' },
        react_1["default"].createElement("button", { type: 'button', className: 'flex items-center justify-center gap-2 bg-white text-black border border-sky-500 p-4 rounded-md w-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-sky-500 hover:bg-sky-100 hover:border-sky-700 transition duration-200', onClick: onClick },
            icon,
